...
newdat <- data.table(expand.grid(tempave.sc = seq(-1.6, 1.5, length.out = 100), tempchange.sc = seq(-0.7953, 47, length.out = 100), duration = seq(1, 10, length.out=10), REALM = c('Marine', 'Terrestrial', 'Freshwater')))
newdat$STUDY_ID <- 1
newdat$rarefyID <- 1
