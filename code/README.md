...
The code is organized in five main steps. Run time for each step should be less than an hour, except for model fitting. Each model takes up to 48 hrs to fit:
