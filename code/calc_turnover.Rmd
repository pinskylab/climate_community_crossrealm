...
if(file.exists('temp/trendstemp.rds')){
  ...
  trends <- merge(trends1, trends2, all = TRUE, by = 'rarefyID')
...
trends2[, plot(Nspp, JtutrendAll, log = 'x', col = '#00000033')]; abline(h=0)
trends2[, plot(Nspp, JbetatrendAll, log = 'x', col = '#00000033')]; abline(h=0)
trends2[, plot(Nspp, HorntrendAll, log = 'x', col = '#00000033')]; abline(h=0)
