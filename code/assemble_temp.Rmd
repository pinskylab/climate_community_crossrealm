...
endo <- merge(btspp[, .(rarefyID, original_name = Species, REALM, STUDY_ID, taxa_mod)], phylo, 
             all.x = TRUE, by = "original_name")
...
endo[taxa_mod == 'Birds' & metab != 'bird', ][!duplicated(original_name)] # seem correct
endo[taxa_mod == 'Fish' & metab != 'ecto', ][!duplicated(original_name)] # seem correct
endo[taxa_mod == 'Plant' & metab != 'ecto', ][!duplicated(original_name)] # wrong

# fix known errors
endo[original_name == 'Phyllanthus_emblica', metab := 'ecto']
