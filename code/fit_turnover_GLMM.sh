#!/bin/bash
# Script to spawn multiple instances of nohup'ed fit_turnover_GLMM.R
# As arguments, provide the names of models to fit, e.g.,
# fit_turnover_GLMM.sh modAllJtu modAllJbeta
...
while [ "$1" != "" ]; do
    echo "Spawning $1"
    nohup code/fit_turnover_GLMM.R $1 > logs/fit_turnover_GLMM$1.Rout &
