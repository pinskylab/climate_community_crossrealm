...
```{r}
# with Jtu.init
# if(!exists('modInitAllJtu')) modInitAllJtu <- readRDS(here('temp', 'modInitAllJtu.rds')) # Fit by code/turnover_vs_init_GLMM_fit.R. Can't include because fit to a larger dataset.
if(!exists('modsdTRealmtsigninitAllJtu')) modsdTRealmtsigninitAllJtu <- readRDS(here('temp', 'modsdTRealmtsigninitAllJtu.rds')) # Fit by code/turnover_vs_temperature_GLMM_fit_Jtu.init.R
if(!exists('modrawTsdTTRealmtsigninitAllJtu')) modrawTsdTTRealmtsigninitAllJtu <- readRDS(here('temp', 'modrawTsdTTRealmtsigninitAllJtu.rds')) # Fit by code/turnover_vs_temperature_GLMM_fit_Jtu.init.R
...
## AIC: Compare to models without init
```{r}
aics <- AIC(modAllJtu, # simple models w/out tempchange
            modsdTRealmtsignAllJtu, modsdTRealmtsigninitAllJtu, # tsign:tempchange_abs w/out or w/ realm
            modrawTsdTTRealmtsignAllJtu, modrawTsdTTRealmtsigninitAllJtu) # add tempave:tempchange_abs
...
```{r}
# read in slopes
slopessdTRealmtsigninitJtu <- readRDS(here('temp', 'slopes_sdTRealmtsigninitAllJtu.rds')) # made by pred_modrawXAllJtu.sh/.r
