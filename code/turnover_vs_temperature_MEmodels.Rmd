...
fixed <- 'disstrend ~ temptrend_abs.sc*REALM + tempave_metab.sc + temptrend_abs.sc:tempave_metab.sc + mass.sc + temptrend_abs.sc:mass.sc + human_bowler.sc:REALM2 + temptrend_abs.sc:human_bowler.sc:REALM2 + temptrend.sc*REALM + temptrend.sc:tempave_metab.sc + temptrend.sc:mass.sc + temptrend.sc:human_bowler.sc:REALM2'
...
subsetstr = '!(temptrend.sc && temptrend_abs.sc)'
...
# rem0
if(file.exists(here('temp', 'modsdredge5Jtu.rds'))){
  modTsimpJturem0 <- readRDS(here('temp', 'modsdredge5Jtu.rds'))
} else {
...
if(file.exists(here('temp', 'modsdredge5Horn.rds'))){
  modTsimpHornrem0 <- readRDS('temp/modsdredge5Horn.rds')
} else {
