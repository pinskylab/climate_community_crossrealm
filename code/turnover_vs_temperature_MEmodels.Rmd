...
```{r std slope vs. temperature trend vs. duration, message = FALSE, warning = FALSE, fig.width=10, fig.height = 3}
...
```{r first-last dissimilarity vs. temperature trend vs. duration, message = FALSE, warning = FALSE, fig.width=10, fig.height = 3}
...
```{r main effect plots z, fig.width=12, fig.height=12}
...
```{r interaction plots modTfullJtuz, fig.height = 13, fig.width = 9}
...
```{r interaction plots modTfullHornz, fig.height = 13, fig.width = 9}
