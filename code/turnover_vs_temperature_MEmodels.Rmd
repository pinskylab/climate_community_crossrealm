...
trends5Jtu <- trends[complete.cases(disstrend, REALM, tempave_metab.sc, temptrend.sc) & 
                       measure == 'Jtu' & duration == 4, ]
trends5Horn <- trends[complete.cases(disstrend, temptrend.sc, REALM, tempave_metab.sc) & 
                        measure == 'Horn' & duration == 4, ]

# Fit for Jtu (closest to Antao)
