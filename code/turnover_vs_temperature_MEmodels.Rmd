...
cont <- glmmTMBControl(optCtrl=list(iter.max=1e3,eval.max=1e3))
#fixed <- 'disstrend ~ temptrend_abs.sc*REALM + temptrend_abs.sc*tempave_metab.sc + temptrend_abs.sc*seas.sc + temptrend_abs.sc*microclim.sc + temptrend_abs.sc*nspp.sc + temptrend_abs.sc*npp.sc + temptrend_abs.sc*mass.sc + temptrend_abs.sc*human_bowler.sc:REALM2 + temptrend_abs.sc*thermal_bias.sc:tsign'
fixed <- 'disstrend ~ temptrend_abs.sc*REALM + tempave_metab.sc + temptrend_abs.sc:tempave_metab.sc + mass.sc + temptrend_abs.sc:mass.sc + human_bowler.sc:REALM2 + temptrend_abs.sc:human_bowler.sc:REALM2'
fixed <- 'disstrend ~ temptrend_abs.sc*REALM + tempave_metab.sc + temptrend_abs.sc:tempave_metab.sc + mass.sc + human_bowler.sc:REALM2'
...
fixed <- 'disstrend ~ temptrend_abs.sc + tempave_metab.sc + temptrend_abs.sc:tempave_metab.sc + mass.sc + human_bowler.sc'
# trends5Jtu <- trends[complete.cases(disstrend, temptrend_abs.sc, REALM, tempave_metab.sc,
#                                     mass.sc, human_bowler.sc) & measure == 'Jtu' & duration == 4 & REALM == 'Terrestrial', ]
# trends5Horn <- trends[complete.cases(disstrend, temptrend_abs.sc, REALM, tempave_metab.sc,
#                                     mass.sc, human_bowler.sc) & measure == 'Horn' & duration == 4 & REALM == 'Terrestrial', ]
# trends5Jtu <- trends[complete.cases(disstrend, temptrend_abs.sc, REALM, tempave_metab.sc,
#                                     mass.sc, human_bowler.sc) & measure == 'Jtu' & duration == 4 & REALM == 'Marine', ]
# trends5Horn <- trends[complete.cases(disstrend, temptrend_abs.sc, REALM, tempave_metab.sc,
...
if(file.exists(here('temp', 'modsdredge5Jtu.rds'))){
  ...
  #modsel5Jtu <- model.sel(mods5Jtu, rank = 'AIC', fit = FALSE)
  #head(modsel5Jtu)
  modavg5Jtu <- model.avg(mods5Jtu)
  summary(modavg5Jtu)
...
if(file.exists(here('temp', 'modsdredge5Horn.rds'))){
  ...
  mods5Horn <- mclapply(modevals5Horn, eval, mc.cores = 20) # call in parallel
  #saveRDS(mods5Horn, file = here('temp', 'modsdredge5Horn.rds'))
  
  #modsel5Horn <- model.sel(mods5Horn, rank = 'AIC', fit = FALSE)
  #head(modsel5Horn)
  modavg5Horn <- model.avg(mods5Horn)
  summary(modavg5Horn)
