...
newdat <- cbind(expand.grid(temptrend = seq(-1.5, 1.5, length.out = 100), nspp = 2^seq(1, 9, length.out=500)), 
                data.table(REALM = 'Freshwater', REALM2 = 'TerrFresh', tempave.sc = 0, tempave_metab.sc = 0, 
                           ...
                           thermal_bias.sc = 0, npp.sc = 0, human_bowler.sc = 0, veg.sc = 0,
                           consumerfrac.sc = 0,
...
# trim to some temperature change (so that tsign is -1 or 1)
...
NEED TO FIX CODE FOR THERMAL BIAS AND FOR HUMAN IMPACT
