...
# simulation
for(i in 1:nrep){
    simburninSAD[[i]] <- untb(start = sample(metaSAD, 100), prob = 0.1, D = 1, gens = nburn, keep = TRUE, meta = metaSAD) # burnin
...
plot(count(simburninSAD[[1]][1000,]), main = 'Burnin: Final SAD')
...
plot(count(simSAD[[1]][100,]), main = 'Sim: Final SAD')
