...
# Script to fit glmmTMB modrawTsdTTRealmmicroclimhumanAllJtu model
# nohup code/turnover_vs_temperature_GLMM_fit_modrawTsdTTRealmmicroclimhumanAllJtu.R > logs/turnover_vs_temperature_GLMMmodrawTsdTTRealmtsignmicroclimhumanAllJtu.Rout &
# (this works if code is executable, e.g., chmod u+x code/turnover_vs_temperature_GLMM_fit_modrawTsdTTRealmmicroclimhumanAllJtu.R)
# (otherwise using nohup Rscript ...)

# print basic info about the job ############################

print('This is script turnover_vs_temperature_GLMM_fit_modrawTsdTTRealmmicroclimhumanAllJtu.R')
print(paste('This is process #', Sys.getpid()))
print(Sys.time())

fitmod <- 'modrawTsdTTRealmtsignmicroclimhumanAllJtu'
print(fitmod)
