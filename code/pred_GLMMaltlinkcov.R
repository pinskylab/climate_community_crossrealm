...
micromodel <- 'modOBrawTsdTTMERtsRealmtsignmicroclimInitAllJtu_lin'
humanmodel <- 'modOBrawTsdTTMERtsRealmtsignhumanInitAllJtu_lin'
modname <- 'modOBrawTsdTTMERtsRealmtsignCovariateInitAllJtu_lin'
...
# sensitivity2 <- readRDS(here('temp', sesnfile)) # to read in manually
