...
bt[, duration_group := factor(duration_group, levels = c('3', '5', '10', '20', 'All'), ordered = FALSE)]
...
if(!file.exists(here('output', 'slope_w_covariates.csv.gz'))){
  write.csv(bt[,.(STUDY_ID, rarefyID, REALM, Biome, taxa_mod, taxa_mod2, year1, year2, duration_group, duration, 
