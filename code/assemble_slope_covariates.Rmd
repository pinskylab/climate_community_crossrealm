...
pairs(formula = ~ tempave.sc + tempave_metab.sc + seas.sc + microclim.sc + temptrend.sc + temptrend_abs.sc + mass.sc + endothermfrac.sc + nspp.sc + thermal_bias.sc + npp.sc + human_bowler.sc, data = bt[measure == 'Jtu' & year2 - year1 == 2], gap = 1/10, cex = 0.2, col = '#00000022', lower.panel = panel.cor)
...
ggplot(bt[measure == 'Jtu'], aes(REALM, disstrend)) +
  ...
  facet_wrap(vars(duration), scales = 'free')
```
