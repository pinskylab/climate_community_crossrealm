...
## Make predictions data.frame from boostrapped Tchange and Tchange x Tave models
#
# run as
# nohup Rscript --vanilla code/pred_GLMM_boot.R X > logs/pred_GLMMmodrawXAllJtu_X.Rout &
# where X is an argument (see below)
# or as:
# pred_GLMM_boot.sh X1 X2
# which spawns a job for each argument
# set to run on Annotate2
