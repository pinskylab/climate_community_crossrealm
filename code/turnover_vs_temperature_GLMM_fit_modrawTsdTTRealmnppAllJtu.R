...
# nohup code/turnover_vs_temperature_GLMM_fit_modrawTsdTTRealmnppAllJtu.R > logs/turnover_vs_temperature_GLMMmodrawTsdTTRealmtsignnppAllJtu.Rout &
...
print(paste('This is script turnover_vs_temperature_GLMM_fit_modrawTsdTTRealmnppAllJtu.R'))
print(paste('This is process #', Sys.getpid()))
print(Sys.time())

fitmod <- 'modrawTsdTTRealmtsignnppAllJtu'
