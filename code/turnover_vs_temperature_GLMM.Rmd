...
CIs are from a SEM fit to the trends.
```{r, echo = FALSE}
vals <- slopessdTRealmAllJtu[c(which.min(abs(tempave - 10)), which.min(abs(tempave-25))), unique(tempave)] # show 10 and 25degC
...
CIs are from a SEM fit to the trends.
```{r, echo = FALSE}
vals <- slopesrawsdTRealmtsignAllJtu[c(which.min(abs(tempave - 10)), which.min(abs(tempave-25))), unique(tempave)] # show 10 and 25degC
...
CIs are from a SEM fit to the trends.
```{r, echo = FALSE}
vals <- slopesrawTsdTAllJtu[c(which.min(abs(tempave - 10)), which.min(abs(tempave-25))), unique(tempave)] # show 10 and 25degC
...
CIs are from a SEM fit to the trends.
```{r, echo = FALSE}
vals <- slopesrawTsdTtsignAllJtu[c(which.min(abs(tempave - 10)), which.min(abs(tempave-25))), unique(tempave)] # show 10 and 25degC
...
CIs are from a SEM fit to the trends.
```{r, echo = FALSE}
vals <- slopesrawTsdTRealmAllJtu[c(which.min(abs(tempave - 10)), which.min(abs(tempave-25))), unique(tempave)] # show 10 and 25degC
...
CIs are from a SEM fit to the trends.
```{r, echo = FALSE}
vals <- slopesrawTsdTRealmtsignAllJtu[c(which.min(abs(tempave - 10)), which.min(abs(tempave-25))), unique(tempave)] # show 10 and 25degC
