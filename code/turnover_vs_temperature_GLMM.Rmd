...
aics3 <- AIC(modAllJtu, modRealmAllJtu, moddTAllJtu, modsdTAllJtu, # one var
             ...
             modrawTdTTRealmAllJtu, modrawTsdTTRealmAllJtu) # three vars
...
Uses output from pred_GLMMmodrawTsdTTRealmAllJtu.R (abs) and pred_GLMMmodrawTdTTRealmAllJtu.R (not abs).
```{r, echo = FALSE}
...
#### AIC
```{r}
aics <- AIC(modRealmAllJtu, moddTRealmAllJtu, modrawTsdTTRealmAllJtu, modrawTsdTTRealmnppAllJtu, modrawTsdTTRealmseasAllJtu, modrawTsdTTRealmmicroclimAllJtu, modrawTsdTTRealmhumanAllJtu)
aics$dAIC <- aics$AIC - min(aics$AIC)
aics
...
modTsdTTRealmthermal_biasAllJtu_thermal_biasdata <- readRDS(here('temp','modTsdTTRealmthermal_biasAllJtu_thermal_biasdata_test.rds')) # has thermal bias as well
...
modrawTsdTTRealmthermal_biasAllJtu_thermal_biasdata <- readRDS(here('temp','modrawTsdTTRealmthermal_biasAllJtu_thermal_biasdata.rds')) # has thermal bias as well

aics <- AIC(modrawTsdTTRealmAllJtu_thermal_biasdata, modrawTsdTTRealmtsignAllJtu_thermal_biasdata, modrawTsdTTRealmthermal_biasAllJtu_thermal_biasdata)
aics$dAIC <- aics$AIC - min(aics$AIC)
aics
```
...
```{r, echo = FALSE}
#modrawTsdTTRealmTaxamod2FEsdTAllJtu <- readRDS(here('temp', 'modrawTsdTTRealmTaxamod2FEsdTAllJtu')) # has taxa_mod2:tempchange_abs
modrawTsdTTRealmTaxamod2FEAllJtu <- readRDS(here('temp', 'modrawTsdTTRealmTaxamod2FEAllJtu_test.rds')) # has taxa_mod2:tempave:tempchange_abs

# previous models
modRealmAllJtu <- readRDS(here('temp', 'modRealmAllJtu.rds')) # only realm
moddTRealmAllJtu <- readRDS(here('temp', 'moddTRealmAllJtu.rds')) # uses tempchange
modrawTsdTTRealmAllJtu <- readRDS(here('temp', 'modrawTsdTTRealmAllJtu.rds')) # uses environmental temperature and tempchange_abs

```

#### AIC
```{r}
aics <- AIC(modRealmAllJtu, moddTRealmAllJtu, modrawTsdTTRealmAllJtu, modrawTsdTTRealmTaxamod2FEAllJtu)
