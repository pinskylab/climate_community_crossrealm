...
3rd best is same as 10- and 20-years: beta errors, random slopes (duration.sc) & intercepts for STUDY_ID and rarefyID, and variance scaled to nspp + realm.
...
### 5-years
Best is beta errors, durationlog.sc, intercepts for STUDY_ID and rarefyID, variance scaled to nspp + realm.
Next best is same as 10- and 20-years: beta errors, random slopes (duration.sc) & intercepts for STUDY_ID and rarefyID, and variance scaled to nspp + realm.
We haven't dealt with potential testing on the boundary issues here. Note that a number of models with random slopes did not converge.
```{r choose variance structure, echo=FALSE}
