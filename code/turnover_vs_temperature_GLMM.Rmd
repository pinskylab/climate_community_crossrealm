...
aics3 <- AIC(modAllJtu, modRealmAllJtu, moddTAllJtu, modsdTAllJtu, modrawsdTtsignAllJtu, # tempchange or tempchange_abs or tsign:tempchange_abs (one var)
             moddTRealmAllJtu, modsdTRealmAllJtu, modrawsdTRealmtsignAllJtu, # one var with realm
             modrawTdTTAllJtu, modrawTsdTTAllJtu, modrawTsdTTtsignAllJtu, # add tempave w/out realm
             modrawTdTTRealmAllJtu, modrawTsdTTRealmAllJtu, modrawTsdTTRealmtsignAllJtu)# add tempave and realm
aics3$dAIC <- aics3$AIC - min(aics3$AIC)
aics3
```
