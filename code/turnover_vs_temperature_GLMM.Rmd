...
### Load the models
```{r temperature only, eval=FALSE, echo=FALSE}
# all years
...
### Summary (all years)
```{r summary onlyTchange, eval=FALSE, echo=FALSE}
...
### Summary (1 year)
```{r summary onlyTchange1yr, eval=FALSE, echo=FALSE}
summary(modonlyTchange1yrJtu)
summary(modonlyTchange1yrJbeta)
summary(modonlyTchange1yrHorn)
```
### Summary (10 year)
```{r summary onlyTchange10yr, eval=FALSE, echo=FALSE}
...
```{r modonlyT coefs, eval=FALSE, echo=FALSE}
...
### Load the models
```{r temperature and duration, eval=FALSE, echo=FALSE}
# all years
...
Not run. These don't seem the most informative right now, since they lack many of the other factors that are likely important, like average temperature.

### Load the models
```{r temperature duration realm, echo=FALSE, eval=FALSE}
# all years
...
### Summary
```{r summary of TDrealm mods, echo=FALSE, eval=FALSE}
...
### Summary (1 yr)
```{r summary of Trealm1yr mods, echo=FALSE, eval=FALSE}
...
### Summary (10 yr)
```{r summary of Trealm10yr mods, echo=FALSE, eval=FALSE}
...
```{r modTD realm coefs, echo=FALSE, eval=FALSE}
...
```{r durint, echo=FALSE}
# all years
if(file.exists('temp/modDurIntTdTSeMiNPNspMaHu5yrJtu.rds')) modDurInt5yrJut <- readRDS('temp/modDurIntTdTSeMiNPNspMaHu5yrJtu.rds')

```

### Summary
```{r summary durint, echo=FALSE}
if(exists('modDurInt5yrJut')) summary(modDurInt5yrJut)
```
