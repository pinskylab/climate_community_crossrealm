---
title: 'Temperature change and the community response to temperature change across realms using beta models'
...
### Summary (all years)
```{r summary onlyTchange, eval=FALSE}
...
### Load the models
```{r temperature and duration, eval=FALSE}
# all years
...
### Summary
```{r summary of TD mods, eval=FALSE}
summary(modTDJtu)
summary(modTDJbeta)
summary(modTDHorn)
```
...
These don't seem the most informative right now, since they lack many of the other factors that are likely important, like average temperature.
### Load the models
