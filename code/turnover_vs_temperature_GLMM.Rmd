...
newdat5$Jtu.sc <- predict(modTdTRealm5Jtu, newdat = newdat5, type = 'response', se.fit = FALSE, re.form = NA) # make the predictions

newdat5[REALM == 'Freshwater', Jtu.sc.FreshdTu := invlogit(logit(Jtu.sc) + 
                                  tempchange_abs.sc * duration.sc *
                                  coefs5Jtu[terms5Jtu == 'REALMFreshwater:duration.sc:tempchange_abs.sc',2]) # upper bound on dT coef freshwater
newdat5[REALM == 'Freshwater', Jtu.sc.FreshdTl <- invlogit(logit(Jtu.sc) - 
                                  tempchange_abs.sc * duration.sc *
                                  coefs5Jtu[terms5Jtu == 'REALMFreshwater:duration.sc:tempchange_abs.sc',2]) # lower bound
newdat5[REALM == 'Marine', Jtu.sc.MardTu <- invlogit(logit(Jtu.sc) + 
                                  tempchange_abs.sc * duration.sc *
                                  coefs5Jtu[terms5Jtu == 'REALMMarine:duration.sc:tempchange_abs.sc',2])
newdat5[REALM == 'Marine', Jtu.sc.MardTl <- invlogit(logit(Jtu.sc) - 
                                  tempchange_abs.sc * duration.sc *
                                  coefs5Jtu[terms5Jtu == 'REALMMarine:duration.sc:tempchange_abs.sc',2])
newdat5[REALM == 'Terrestrial', Jtu.sc.TerrdTu <- invlogit(logit(Jtu.sc) + 
                                  tempchange_abs.sc * duration.sc *
                                  coefs5Jtu[terms5Jtu == 'REALMTerrestrial:duration.sc:tempchange_abs.sc',2])
newdat5[REALM == 'Terrestrial', Jtu.sc.TerrdTl <- invlogit(logit(Jtu.sc) - 
                                  tempchange_abs.sc * duration.sc *
                                  coefs5Jtu[terms5Jtu == 'REALMTerrestrial:duration.sc:tempchange_abs.sc',2])

newdat5[REALM == 'Freshwater', Jtu.sc.FreshTu <- invlogit(logit(Jtu.sc) + 
                                 tempave_metab.sc * duration.sc *
                                 coefs5Jtu[terms5Jtu == 'REALMFreshwater:duration.sc:tempave_metab.sc',2]) # upper bound on T coef
newdat5[REALM == 'Freshwater', Jtu.sc.FreshTl <- invlogit(logit(Jtu.sc) - 
                                 tempave_metab.sc * duration.sc *
                                 coefs5Jtu[terms5Jtu == 'REALMFreshwater:duration.sc:tempave_metab.sc',2]) # lower bound
newdat5[REALM == 'Marine', Jtu.sc.MarTu <- invlogit(logit(Jtu.sc) + 
                                 tempave_metab.sc * duration.sc *
                                 coefs5Jtu[terms5Jtu == 'REALMMarine:duration.sc:tempave_metab.sc',2])
newdat5[REALM == 'Marine', Jtu.sc.MarTl <- invlogit(logit(Jtu.sc) - 
                                 tempave_metab.sc * duration.sc *
                                 coefs5Jtu[terms5Jtu == 'REALMMarine:duration.sc:tempave_metab.sc',2])
newdat5[REALM == 'Terrestrial', Jtu.sc.TerrTu <- invlogit(logit(Jtu.sc) + 
                                 tempave_metab.sc * duration.sc *
                                 coefs5Jtu[terms5Jtu == 'REALMTerrestrial:duration.sc:tempave_metab.sc',2])
newdat5[REALM == 'Terrestrial', Jtu.sc.TerrTl <- invlogit(logit(Jtu.sc) - 
                                 tempave_metab.sc * duration.sc *
                                 coefs5Jtu[terms5Jtu == 'REALMTerrestrial:duration.sc:tempave_metab.sc',2])

# write out
write.csv(newdat5, 'temp/modTdTTRealm5_preds.csv', row.names = FALSE)
...
### Load the models
```{r, echo=FALSE}
modnames <- c('modNull', 'modRealm', 'modT', 'moddT', 'modmass', 'modnpp', 'modseas', 'modmicroclim', 'modhuman', 'modTdT', 'modTRealm', 'modTmicroclim', 'moddTRealm', 'moddTmicroclim', 'modTxRealm', 'moddTxRealm', 'modTdTRealm', 'modTdTtsign', 'modTdTmass', 'modTdTnpp', 'modTdTseas', 'modTdTmicroclim', 'modTdThuman', 'modTdTT')
...
conv <- sapply(mods5Jtu, FUN = function(x) return(x$fit$convergence))
...
conv <- sapply(mods5Horn, FUN = function(x) return(x$fit$convergence))
good <- modes == 'list' & conv == 0
if(!all(unlist(nobs[good]) == nobs[good][1])) print('NOT ALL THE SAME! AIC is meaningless')
if(sum(conv==0) != length(conv)){
