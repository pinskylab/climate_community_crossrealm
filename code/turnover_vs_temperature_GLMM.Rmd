...
# Models
All fit by turnover_vs_temperature_GLMM.R on the command line
...
AICtab(modRFgauss, modRFbeta, modRFnestedRE)
```
...
if(file.exists('temp/modonlyTchangeJtu.rds')) modonlyTchangeJtu <- readRDS('temp/modonlyTchangeJtu.rds')
if(file.exists('temp/modonlyTchangeJbeta.rds')) modonlyTchangeJbeta <- readRDS('temp/modonlyTchangeJbeta.rds')
if(file.exists('temp/modonlyTchangeHorn.rds')) modonlyTchangeHorn <- readRDS('temp/modonlyTchangeHorn.rds')
...
if(file.exists('temp/modTDJtu.rds')) modTDJtu <- readRDS('temp/modTDJtu.rds')
if(file.exists('temp/modTDJbeta.rds')) modTDJbeta <- readRDS('temp/modTDJbeta.rds')
if(file.exists('temp/modTDHorn.rds')) modTDHorn <- readRDS('temp/modTDHorn.rds')
