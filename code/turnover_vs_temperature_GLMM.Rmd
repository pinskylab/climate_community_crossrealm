...
# environmental temperature with tempave + tempchange
modrawTdTAllJtu <- readRDS(here('temp', 'modrawTdTAllJtu.rds')) # tempave + tempchange
modrawTsdTAllJtu <- readRDS(here('temp', 'modrawTsdTAllJtu.rds')) # tempave + tempchange_abs
modrawTdTRealmAllJtu <- readRDS(here('temp', 'modrawTdTRealmAllJtu.rds')) # tempave:REALM + tempchange:REALM
modrawTsdTRealmAllJtu <- readRDS(here('temp', 'modrawTsdTRealmAllJtu.rds')) # tempave:REALM + tempchange_abs:REALM
modrawTsdTtsignAllJtu <- readRDS(here('temp', 'modrawTsdTtsignAllJtu.rds'))
modrawTsdTRealmtsignAllJtu <- readRDS(here('temp', 'modrawTsdTRealmtsignAllJtu.rds'))

# environmental temperature with tempave:tempchange
modrawTdTTAllJtu <- readRDS(here('temp', 'modrawTdTTAllJtu.rds')) # tempave * tempchange
modrawTsdTTAllJtu <- readRDS(here('temp', 'modrawTsdTTAllJtu.rds')) # tempave * tempchange_abs
modrawTdTTRealmAllJtu <- readRDS(here('temp', 'modrawTdTTRealmAllJtu.rds')) # tempave * tempchange and realm
modrawTsdTTRealmAllJtu <- readRDS(here('temp', 'modrawTsdTTRealmAllJtu.rds')) # tempave * tempchange_abs and realm
...
aics
```
#### Metabolic vs. environmental temperature
...
##### Only tempchange (no tempave)
```{r, rows.print=15}
aics3 <- AIC(modAllJtu, modRealmAllJtu, moddTAllJtu, modsdTAllJtu, modrawsdTtsignAllJtu, # one var
             moddTRealmAllJtu, modsdTRealmAllJtu, modrawsdTRealmtsignAllJtu # one var with realm
             ) # tsign
aics3$dAIC <- aics3$AIC - min(aics3$AIC)
aics3
```
##### With tempave + tempchange
```{r, rows.print=15}
aics3 <- AIC(modAllJtu, modRealmAllJtu, moddTAllJtu, modsdTAllJtu, modrawsdTtsignAllJtu, # tempchange or tempchange_abs or tsign:tempchange_abs (one var)
             moddTRealmAllJtu, modsdTRealmAllJtu, modrawsdTRealmtsignAllJtu, # tempchange with realm
             modrawTdTAllJtu, modrawTsdTAllJtu, modrawTsdTtsignAllJtu,  # tempave + tempchange
             modrawTdTRealmAllJtu, modrawTsdTRealmAllJtu, modrawTsdTRealmtsignAllJtu) # tempave:REALM + tempchange:REALM
aics3$dAIC <- aics3$AIC - min(aics3$AIC)
aics3
```
##### With tempave * tempchange (realm or no realm)
```{r, rows.print=20}
aics3 <- AIC(modAllJtu, modRealmAllJtu, moddTAllJtu, modsdTAllJtu, modrawsdTtsignAllJtu, # tempchange or tempchange_abs or tsign:tempchange_abs (one var)
             moddTRealmAllJtu, modsdTRealmAllJtu, modrawsdTRealmtsignAllJtu, # tempchange with realm
             modrawTdTAllJtu, modrawTsdTAllJtu, modrawTsdTtsignAllJtu,  # tempave + tempchange
             modrawTdTRealmAllJtu, modrawTsdTRealmAllJtu, modrawTsdTRealmtsignAllJtu, # tempave:REALM + tempchange:REALM
             modrawTdTTAllJtu, modrawTsdTTAllJtu, modrawTsdTTtsignAllJtu, # add tempave*tempchange w/out realm
             modrawTdTTRealmAllJtu, modrawTsdTTRealmAllJtu, modrawTsdTTRealmtsignAllJtu)# add tempave*tempchange and realm
aics3$dAIC <- aics3$AIC - min(aics3$AIC)
aics3
```

##### With tempave * tempchange and realm
```{r, rows.print=20}
aics3 <- AIC(modAllJtu, modRealmAllJtu, # tempchange or tempchange_abs or tsign:tempchange_abs (one var)
             moddTRealmAllJtu, modsdTRealmAllJtu, modrawsdTRealmtsignAllJtu, # tempchange with realm
             modrawTdTRealmAllJtu, modrawTsdTRealmAllJtu, modrawTsdTRealmtsignAllJtu, # tempave:REALM + tempchange:REALM
             modrawTdTTRealmAllJtu, modrawTsdTTRealmAllJtu, modrawTsdTTRealmtsignAllJtu)# add tempave*tempchange and realm
aics3$dAIC <- aics3$AIC - min(aics3$AIC)
...
```{r, echo = FALSE}
# using tempchange_abs : realm
if(file.exists(here('temp', 'slopes_modsdTRealmAllJtu.rds'))){
  slopessdTRealmAllJtu <- readRDS(here('temp', 'slopes_modsdTRealmAllJtu.rds'))
  print('Loaded sdTRealmAllJtu predictions from file')
} else {
  print('No modsdTRealmAllJtu effects. Need to run code/pred_modrawXAllJtu.sh modsdTRealmAllJtu')
}

# using tsign:tempchange_abs:realm
if(file.exists(here('temp', 'slopes_modrawsdTRealmtsignAllJtu.rds'))){
  slopesrawsdTRealmtsignAllJtu <- readRDS(here('temp', 'slopes_modrawsdTRealmtsignAllJtu.rds'))
  print('Loaded rawsdTRealmtsignAllJtu predictions from file')
} else {
  print('No modrawsdTRealmtsignAllJtu effects. Need to run code/pred_modrawXAllJtu.sh modrawsdTRealmtsignAllJtu')
}

# using tempchange_abs +tempave
if(file.exists(here('temp', 'slopes_modrawTsdTAllJtu.rds'))){
  slopesrawTsdTAllJtu <- readRDS(here('temp', 'slopes_modrawTsdTAllJtu.rds'))
  print('Loaded rawTsdTAllJtu predictions from file')
} else {
  print('No modrawTsdTAllJtu effects. Need to run code/pred_modrawXAllJtu.sh modrawTsdTAllJtu')
}

# using tsign:tempchange_abs +tempave
if(file.exists(here('temp', 'slopes_modrawTsdTtsignAllJtu.rds'))){
  slopesrawTsdTtsignAllJtu <- readRDS(here('temp', 'slopes_modrawTsdTtsignAllJtu.rds'))
  print('Loaded rawTsdTtsignAllJtu predictions from file')
} else {
  print('No modrawTsdTtsignAllJtu effects. Need to run code/pred_modrawXAllJtu.sh modrawTsdTtsignAllJtu')
}

# using (tempchange_abs +tempave):realm
if(file.exists(here('temp', 'slopes_modrawTsdTRealmAllJtu.rds'))){
  slopesrawTsdTRealmAllJtu <- readRDS(here('temp', 'slopes_modrawTsdTRealmAllJtu.rds'))
  print('Loaded rawTsdTRealmAllJtu predictions from file')
} else {
  print('No modrawTsdTRealmAllJtu effects. Need to run code/pred_modrawXAllJtu.sh modrawTsdTRealmAllJtu')
}

# using (tsign:tempchange_abs +tempave):realm
if(file.exists(here('temp', 'slopes_modrawTsdTRealmtsignAllJtu.rds'))){
  slopesrawTsdTRealmtsignAllJtu <- readRDS(here('temp', 'slopes_modrawTsdTRealmtsignAllJtu.rds'))
  print('Loaded rawTsdTRealmtsignAllJtu predictions from file')
} else {
  print('No modrawTsdTRealmtsignAllJtu effects. Need to run code/pred_modrawXAllJtu.sh modrawTsdTRealmtsignAllJtu')
}
...
# using tempchange * tempave * realm
...
# using tsign:tempchange_abs * tempave * realm
if(file.exists(here('temp', 'slopes_rawRealmtsign.rds'))){
...
```
#### tempchange_abs:realm plots
##### Interaction
```{r, echo = FALSE}
p1 <- ggplot(slopessdTRealmAllJtu[REALM=='Marine'], aes(tempchange, tempave, z = slope)) +
    geom_raster(aes(fill = slope)) +
    ...
    theme(axis.text = element_text(size = 12), 
          ...
          legend.title=element_text(size= 18),
          legend.title.align = 1)
p2 <- ggplot(slopessdTRealmAllJtu[REALM=='Terrestrial'], aes(tempchange, tempave, z = slope)) +
    geom_raster(aes(fill = slope)) +
    ...
    theme(axis.text = element_text(size = 12), 
          ...
          legend.title=element_text(size= 18),
          legend.title.align = 1)
p3 <- ggplot(slopessdTRealmAllJtu[REALM=='Freshwater'], aes(tempchange, tempave, z = slope)) +
    geom_raster(aes(fill = slope)) +
...
CIs are from a SEM fit to the trends.
```{r, echo = FALSE}
vals <- slopessdTRealmAllJtu[c(which.min(abs(tempave - 0)), which.min(abs(tempave-25))), unique(tempave)] # show 0 and 25degC
ggplot(slopessdTRealmAllJtu[tempave %in% vals,], 
...
##### Interaction
```{r, echo = FALSE}
p1 <- ggplot(slopesrawsdTRealmtsignAllJtu[REALM=='Marine'], aes(tempchange, tempave, z = slope)) +
    geom_raster(aes(fill = slope)) +
    labs(x = 'Temperature change (degC per year)', y = 'Environmental temperature (degC)', title = 'Marine') +
    scale_fill_gradient2(high= "#B2182B", mid = "white", low= "#2166AC", midpoint = 0) +
    theme(axis.text = element_text(size = 12), 
          ...
          legend.title=element_text(size= 18),
          legend.title.align = 1)
p2 <- ggplot(slopesrawsdTRealmtsignAllJtu[REALM=='Terrestrial'], aes(tempchange, tempave, z = slope)) +
    geom_raster(aes(fill = slope)) +
    labs(x = 'Temperature change (degC per year)', y = 'Environmental temperature (degC)', title = 'Terrestrial') +
    scale_fill_gradient2(high= "#B2182B", mid = "white", low= "#2166AC", midpoint = 0) +
    theme(axis.text = element_text(size = 12), 
          ...
          legend.title=element_text(size= 18),
          legend.title.align = 1)
p3 <- ggplot(slopesrawsdTRealmtsignAllJtu[REALM=='Freshwater'], aes(tempchange, tempave, z = slope)) +
    geom_raster(aes(fill = slope)) +
    labs(x = 'Temperature change (degC per year)', y = 'Environmental temperature (degC)', title = 'Freshwater') +
    scale_fill_gradient2(high= "#B2182B", mid = "white", low= "#2166AC", midpoint = 0) +
    theme(axis.text = element_text(size = 12), 
...
CIs are from a SEM fit to the trends.
```{r, echo = FALSE}
vals <- slopesrawsdTRealmtsignAllJtu[c(which.min(abs(tempave - 0)), which.min(abs(tempave-25))), unique(tempave)] # show 0 and 25degC
ggplot(slopesrawsdTRealmtsignAllJtu[tempave %in% vals,], 
       aes(tempchange, slope, color = factor(round(tempave)), group = tempave)) +
    geom_line() +
    geom_pointrange(aes(ymin=slope-1.96*slope.se, ymax=slope+1.96*slope.se), alpha = 0.25) + 
    facet_grid(cols = vars(REALM))  +
...
#### tempchange_abs + tempave plots
##### Interaction
```{r, echo = FALSE}
p1 <- ggplot(slopesrawTsdTAllJtu[REALM=='Marine'], aes(tempchange, tempave, z = slope)) +
    geom_raster(aes(fill = slope)) +
    labs(x = 'Temperature change (degC per year)', y = 'Environmental temperature (degC)', title = 'All realms') +
    scale_fill_gradient2(high= "#B2182B", mid = "white", low= "#2166AC", midpoint = 0) +
    theme(axis.text = element_text(size = 12), 
          axis.title = element_text(size = 14),
          panel.background = element_blank(),
...
CIs are from a SEM fit to the trends.
```{r, echo = FALSE}
vals <- slopesrawTsdTAllJtu[c(which.min(abs(tempave - 0)), which.min(abs(tempave-25))), unique(tempave)] # show 0 and 25degC
ggplot(slopesrawTsdTAllJtu[tempave %in% vals,], 
       aes(tempchange, slope, color = factor(round(tempave)), group = tempave)) +
    geom_line() +
    geom_pointrange(aes(ymin=slope-1.96*slope.se, ymax=slope+1.96*slope.se), alpha = 0.25) + 
    labs(x = 'dT [degC/yr]') +
...
#### tsign:tempchange_abs + tempave plots
##### Interaction
```{r, echo = FALSE}
p1 <- ggplot(slopesrawTsdTtsignAllJtu[REALM=='Marine'], aes(tempchange, tempave, z = slope)) +
    geom_raster(aes(fill = slope)) +
    labs(x = 'Temperature change (degC per year)', y = 'Environmental temperature (degC)', title = 'All realms') +
    scale_fill_gradient2(high= "#B2182B", mid = "white", low= "#2166AC", midpoint = 0) +
    theme(axis.text = element_text(size = 12), 
...
CIs are from a SEM fit to the trends.
```{r, echo = FALSE}
vals <- slopesrawTsdTtsignAllJtu[c(which.min(abs(tempave - 0)), which.min(abs(tempave-25))), unique(tempave)] # show 0 and 25degC
ggplot(slopesrawTsdTtsignAllJtu[tempave %in% vals,], 
       aes(tempchange, slope, color = factor(round(tempave)), group = tempave)) +
    geom_line() +
    geom_pointrange(aes(ymin=slope-1.96*slope.se, ymax=slope+1.96*slope.se), alpha = 0.25) + 
    labs(x = 'dT [degC/yr]') +
...
#### (tempchange_abs + tempave plots):realm
##### Interaction
```{r, echo = FALSE}
p1 <- ggplot(slopesrawTsdTRealmAllJtu[REALM=='Marine'], aes(tempchange, tempave, z = slope)) +
    geom_raster(aes(fill = slope)) +
    labs(x = 'Temperature change (degC per year)', y = 'Environmental temperature (degC)', title = 'Marine') +
    scale_fill_gradient2(high= "#B2182B", mid = "white", low= "#2166AC", midpoint = 0) +
    theme(axis.text = element_text(size = 12), 
          ...
          legend.title=element_text(size= 18),
          legend.title.align = 1)
p2 <- ggplot(slopesrawTsdTRealmAllJtu[REALM=='Terrestrial'], aes(tempchange, tempave, z = slope)) +
    geom_raster(aes(fill = slope)) +
    labs(x = 'Temperature change (degC per year)', y = 'Environmental temperature (degC)', title = 'Terrestrial') +
    scale_fill_gradient2(high= "#B2182B", mid = "white", low= "#2166AC", midpoint = 0) +
    theme(axis.text = element_text(size = 12), 
          ...
          legend.title=element_text(size= 18),
          legend.title.align = 1)
p3 <- ggplot(slopesrawTsdTRealmAllJtu[REALM=='Freshwater'], aes(tempchange, tempave, z = slope)) +
    geom_raster(aes(fill = slope)) +
    labs(x = 'Temperature change (degC per year)', y = 'Environmental temperature (degC)', title = 'Freshwater') +
    scale_fill_gradient2(high= "#B2182B", mid = "white", low= "#2166AC", midpoint = 0) +
    theme(axis.text = element_text(size = 12), 
...
CIs are from a SEM fit to the trends.
```{r, echo = FALSE}
vals <- slopesrawTsdTRealmAllJtu[c(which.min(abs(tempave - 0)), which.min(abs(tempave-25))), unique(tempave)] # show 0 and 25degC
ggplot(slopesrawTsdTRealmAllJtu[tempave %in% vals,], 
       aes(tempchange, slope, color = factor(round(tempave)), group = tempave)) +
  geom_line() +
  geom_pointrange(aes(ymin=slope-1.96*slope.se, ymax=slope+1.96*slope.se), alpha = 0.25) + 
  facet_grid(cols = vars(REALM))  +
...
#### (tsign:tempchange_abs + tempave plots):realm
##### Interaction
```{r, echo = FALSE}
p1 <- ggplot(slopesrawTsdTRealmtsignAllJtu[REALM=='Marine'], aes(tempchange, tempave, z = slope)) +
    geom_raster(aes(fill = slope)) +
    labs(x = 'Temperature change (degC per year)', y = 'Environmental temperature (degC)', title = 'Marine') +
    scale_fill_gradient2(high= "#B2182B", mid = "white", low= "#2166AC", midpoint = 0) +
    theme(axis.text = element_text(size = 12), 
          ...
          legend.title=element_text(size= 18),
          legend.title.align = 1)
p2 <- ggplot(slopesrawTsdTRealmtsignAllJtu[REALM=='Terrestrial'], aes(tempchange, tempave, z = slope)) +
    geom_raster(aes(fill = slope)) +
    labs(x = 'Temperature change (degC per year)', y = 'Environmental temperature (degC)', title = 'Terrestrial') +
    scale_fill_gradient2(high= "#B2182B", mid = "white", low= "#2166AC", midpoint = 0) +
    theme(axis.text = element_text(size = 12), 
          ...
          legend.title=element_text(size= 18),
          legend.title.align = 1)
p3 <- ggplot(slopesrawTsdTRealmtsignAllJtu[REALM=='Freshwater'], aes(tempchange, tempave, z = slope)) +
    geom_raster(aes(fill = slope)) +
    labs(x = 'Temperature change (degC per year)', y = 'Environmental temperature (degC)', title = 'Freshwater') +
    scale_fill_gradient2(high= "#B2182B", mid = "white", low= "#2166AC", midpoint = 0) +
    theme(axis.text = element_text(size = 12), 
...
CIs are from a SEM fit to the trends.
```{r, echo = FALSE}
vals <- slopesrawTsdTRealmtsignAllJtu[c(which.min(abs(tempave - 0)), which.min(abs(tempave-25))), unique(tempave)] # show 0 and 25degC
ggplot(slopesrawTsdTRealmtsignAllJtu[tempave %in% vals,], 
       aes(tempchange, slope, color = factor(round(tempave)), group = tempave)) +
  geom_line() +
  geom_pointrange(aes(ymin=slope-1.96*slope.se, ymax=slope+1.96*slope.se), alpha = 0.25) + 
  facet_grid(cols = vars(REALM))  +
...
#### tempave*tempchange*realm plots
##### Interaction
```{r, echo = FALSE}
...
CIs are from a SEM fit to the trends.
```{r, fig.height=8}
vals <- slopesrawTdTT[c(which.min(abs(tempave - 0)), which.min(abs(tempave-25))), unique(tempave)] # show 0 and 25degC
...
#### tempave*tempchange_abs*realm plots
##### Interaction
```{r, echo = FALSE}
...
CIs are from a SEM fit to the trends.
```{r, echo = FALSE}
vals <- slopesrawTsdTT[c(which.min(abs(tempave - 0)), which.min(abs(tempave-25))), unique(tempave)] # show 0 and 25degC
...
CIs are from a SEM fit to the trends.
```{r, echo=FALSE}
vals <- slopestsign[c(which.min(abs(tempave - 0)), which.min(abs(tempave-25))), unique(tempave)] # show 0 and 25degC
...
##### Compare tsign covariate models
```{r, rows.print=15}
aics <- AIC(modrawTsdTTtsignAllJtu, modrawTsdTTRealmtsignAllJtu,
            modrawTsdTTRealmtsignnppAllJtu, modrawTsdTTRealmtsignseasAllJtu, # w/tsign
...
p4
```
##### Plot the interactions for complex, non-tsign models
These have an interaction of covariate with tempave but don't have tsign.
