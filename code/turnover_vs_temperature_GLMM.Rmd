...
modrawTsdTTRealmAllJtu <- readRDS(here('temp', 'modrawTsdTTRealmAllJtu.rds')) # uses environmental temperature (duration and abs)
```
...
aics <- AIC(modAllJtu, modTdTTRealmAllJtu, modTdTTRealmDurscAllJtu, modTsdTTRealmAllJtu, modTsdTTRealmDurscAllJtu)
aics$dAIC <- aics$AIC - min(aics$AIC)
aics
...
#### Make/load the tempchange_abs prediction
