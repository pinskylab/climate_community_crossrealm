...
if(file.exists(here('temp', 'slopes_interactions2.rds'))){
  ...
  print('Need to run pred_GLMMmodrawTsdTTRealmtsignAllJtu.R')
...
```{r, echo = FALSE}
modrawTsdTTRealmTaxamod2FEsdTAllJtu <- readRDS(here('temp', 'modrawTsdTTRealmTaxamod2FEsdTAllJtu_test.rds')) # has taxa_mod2:tempchange_abs
...
modRealmAllJtu <- readRDS(here('temp', 'modRealmAllJtu.rds')) # only realm
moddTRealmAllJtu <- readRDS(here('temp', 'moddTRealmAllJtu.rds')) # uses tempchange
modrawTdTTRealmAllJtu <- readRDS(here('temp', 'modrawTdTTRealmAllJtu.rds')) # uses environmental temperature and tempchange
...
aics <- AIC(modRealmAllJtu, moddTRealmAllJtu, 
            modrawTdTTRealmAllJtu, modrawTsdTTRealmAllJtu,
            modrawTsdTTRealmTaxamod2FEsdTAllJtu, modrawTsdTTRealmTaxamod2FEAllJtu)
