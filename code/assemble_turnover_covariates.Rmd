...
p1 <- ggplot(trends, aes(temptrend, Jtutrendrem0, color = REALM, size = nyrBT)) +
  ...
  labs(x = 'Temperature trend (°C/yr)', y = 'Jaccard turnover', title = 'Without year 1')

p2 <- ggplot(trends, aes(temptrend, Jbetatrendrem0, color = REALM, size = nyrBT)) +
  geom_point(size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE) +
  scale_color_brewer(palette="Set1") + 
  labs(x = 'Temperature trend (°C/year)', y = 'Jaccard total')

p3 <- ggplot(trends, aes(temptrend, Horntrendrem0, color = REALM, size = nyrBT)) +
  geom_point(size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE) +
  scale_color_brewer(palette="Set1") + 
  labs(x = 'Temperature trend (°C/year)', y = 'Morisita-Horn')

p4 <- ggplot(trends, aes(temptrend, Jtutrendz, color = REALM, size = nyrBT)) +
  geom_point(size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE) +
  scale_color_brewer(palette="Set1") + 
  labs(x = 'Temperature trend (°C/yr)', y = 'Jaccard turnover', title = 'Standardized') +
...
p7 <- ggplot(trends, aes(temptrend, Jtulast, color = REALM, size = nyrBT)) +
  ...
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE) +
  scale_color_brewer(palette="Set1") + 
  labs(x = 'Temperature trend (°C/yr)', y = 'Jaccard turnover', title = 'Last')
...
p10 <- ggplot(trends, aes(temptrend, Jtuexp, color = REALM, size = nyrBT)) +
  ...
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE) +
  scale_color_brewer(palette="Set1") + 
  labs(x = 'Temperature trend (°C/yr)', y = 'Jaccard turnover', title = 'Exponential half-saturation') +
  scale_y_log10()
...
p13 <- ggplot(trends, aes(temptrend, Jtumm, color = REALM, size = nyrBT)) +
  geom_point(size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE) +
  scale_color_brewer(palette="Set1") + 
  labs(x = 'Temperature trend (°C/yr)', y = 'Jaccard turnover', title = 'Michalis-Menton half-saturation') +
  scale_y_log10()

p14 <- ggplot(trends, aes(temptrend, Jbetamm, color = REALM, size = nyrBT)) +
  geom_point(size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE) +
  scale_color_brewer(palette="Set1") + 
  labs(x = 'Temperature trend (°C/year)', y = 'Jaccard total') +
...
p15 <- ggplot(trends, aes(temptrend, Hornmm, color = REALM, size = nyrBT)) +
  geom_point(size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE) +
  scale_color_brewer(palette="Set1") + 
  labs(x = 'Temperature trend (°C/year)', y = 'Morisita-Horn') +
...
## MM fit
Lines are ggplot smoother fits.
```{r plot MM turnover v explanatory vars, echo=FALSE, warning = FALSE, message = FALSE, fig.height = 16, fig.width = 9}

p1 <- ggplot(trends, aes(REALM, Jtumm)) +
  geom_boxplot(na.rm = TRUE) + 
  labs(x = 'Realm', y = 'Jaccard turnover half-saturation (MM)') +
  scale_y_log10()

p2 <- ggplot(trends, aes(tempave, Jtumm, size = nyrBT)) +
  geom_point(aes(color = REALM), size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE, color = 'black') +
  scale_color_brewer(palette="Set1") + 
  labs(x = 'Temperature (°C)', y = 'Jaccard turnover half-saturation (MM)') +
  scale_y_log10()

p3 <- ggplot(trends, aes(tempave_metab, Jtumm, size = nyrBT)) +
  geom_point(aes(color = REALM), size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE, color = 'black') +
  scale_color_brewer(palette="Set1") + 
  labs(x = 'Metabolic temperature (°C)', y = 'Jaccard turnover half-saturation (MM)') +
  scale_y_log10()

p4 <- ggplot(trends, aes(seas, Jtumm, size = nyrBT)) +
  geom_point(aes(color = REALM), size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE, color = 'black') +
  scale_color_brewer(palette="Set1") + 
  labs(x = 'Seasonality (°C)', y = 'Jaccard turnover half-saturation (MM)') +
  scale_y_log10()

p5 <- ggplot(trends, aes(microclim, Jtumm, size = nyrBT)) +
  geom_point(aes(color = REALM), size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE, color = 'black') +
  scale_color_brewer(palette="Set1") + 
  scale_x_log10() +
  labs(x = 'Microclimate availability (°C)', y = 'Jaccard turnover half-saturation (MM)') +
  scale_y_log10()

p6 <- ggplot(trends, aes(mass_mean_weight, Jtumm, size = nyrBT)) +
  geom_point(aes(color = REALM), size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE, color = 'black') +
  scale_color_brewer(palette="Set1") + 
  scale_x_log10() +
  labs(x = 'Mass (g))', y = 'Jaccard turnover half-saturation (MM)') +
  scale_y_log10()

p7 <- ggplot(trends, aes(speed_mean_weight+1, Jtumm, size = nyrBT)) +
  geom_point(aes(color = REALM), size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE, color = 'black') +
  scale_color_brewer(palette="Set1") + 
  scale_x_log10() +
  labs(x = 'Speed (km / hr))', y = 'Jaccard turnover half-saturation (MM)') +
  scale_y_log10()

p8 <- ggplot(trends, aes(lifespan_mean_weight, Jtumm, size = nyrBT)) +
  geom_point(aes(color = REALM), size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE, color = 'black') +
  scale_color_brewer(palette="Set1") + 
  scale_x_log10() +
  labs(x = 'Lifespan (yr))', y = 'Jaccard turnover half-saturation (MM)') +
  scale_y_log10()

p9 <- ggplot(trends, aes(consfrac, Jtumm, size = nyrBT)) +
  geom_point(aes(color = REALM), size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs", k = 3), na.rm = TRUE, color = 'black') +
  scale_color_brewer(palette="Set1") + 
  labs(x = 'Fraction consumers', y = 'Jaccard turnover half-saturation (MM)') +
  scale_y_log10()

p10 <- ggplot(trends, aes(endofrac, Jtumm, size = nyrBT)) +
  geom_point(aes(color = REALM), size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs", k = 3), na.rm = TRUE, color = 'black') +
  scale_color_brewer(palette="Set1") + 
  labs(x = 'Fraction endotherms', y = 'Jaccard turnover half-saturation (MM)') +
  scale_y_log10()

p11 <- ggplot(trends, aes(Nspp, Jtumm, size = nyrBT)) +
  geom_point(aes(color = REALM), size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE, color = 'black') +
  scale_color_brewer(palette="Set1") + 
  scale_x_log10() +
  labs(x = 'Number of species', y = 'Jaccard turnover half-saturation (MM)') +
  scale_y_log10()

p12 <- ggplot(trends, aes(thermal_bias, Jtumm, size = nyrBT)) +
  geom_point(aes(color = REALM), size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE, color = 'black') +
  scale_color_brewer(palette="Set1") + 
  labs(x = 'Thermal bias (°C)', y = 'Jaccard turnover half-saturation (MM)') +
  scale_y_log10()

p13 <- ggplot(trends, aes(npp, Jtumm, size = nyrBT)) +
  geom_point(aes(color = REALM), size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE, color = 'black') +
  scale_color_brewer(palette="Set1") + 
  scale_x_log10() +
  labs(x = 'Net primary productivity (mg C / m2 / day)', y = 'Jaccard turnover half-saturation (MM)') +
  scale_y_log10()

p14 <- ggplot(trends, aes(veg, Jtumm, color = REALM, size = nyrBT)) +
  geom_point(size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs", k = 5), na.rm = TRUE) +
  scale_color_brewer(palette="Set1") + 
  labs(x = 'Vegetation score', y = 'Jaccard turnover half-saturation (MM)') +
  scale_y_log10()

p15 <- ggplot(trends, aes(human_bowler, Jtumm, color = REALM, size = nyrBT)) +
  geom_point(size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs", k = 5), na.rm = TRUE) +
  scale_color_brewer(palette="Set1") + 
  labs(x = 'Bowler human impact score', y = 'Jaccard turnover half-saturation (MM)') +
  scale_y_log10()

p16 <- ggplot(trends, aes(human_venter, Jtumm, color = REALM, size = nyrBT)) +
  geom_point(size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs", k = 5), na.rm = TRUE) +
  scale_color_brewer(palette="Set1") + 
  labs(x = 'scaled Human impact score (Venter)', y = 'Jaccard turnover half-saturation (MM)') +
  scale_y_log10()

p17 <- ggplot(trends, aes(human_halpern, Jtumm, color = REALM, size = nyrBT)) +
  geom_point(size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs", k = 5), na.rm = TRUE) +
  scale_color_brewer(palette="Set1") + 
  labs(x = 'scaled Human impact score (Halpern)', y = 'Jaccard turnover half-saturation (MM)') +
  scale_y_log10()
