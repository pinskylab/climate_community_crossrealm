...
bt[, tempchange.sc := scale(tempchange, center = FALSE)] # do not center
...
if(!file.exists(here('output', 'turnover_w_covariates.csv.gz'))){
  write.csv(bt[,.(STUDY_ID, rarefyID, REALM, Biome, taxa_mod, taxa_mod2, duration, tsign, tempave.sc, tempave_metab.sc, seas.sc, 
