...
p18 <- ggplot(trends, aes(temptrend, Jtutrend, color = REALM, size = nyrBT)) +
  geom_point(size = 0.2, alpha = 0.5, na.rm = TRUE) + 
...
p19 <- ggplot(trends, aes(temptrend, Jbetatrend, color = REALM, size = nyrBT)) +
  geom_point(size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE) +
  scale_color_brewer(palette="Set1") + 
...
p20 <- ggplot(trends, aes(temptrend, Horntrend, color = REALM, size = nyrBT)) +
  geom_point(size = 0.2, alpha = 0.5, na.rm = TRUE) + 
  geom_smooth(method = 'gam', formula = y ~ s(x, bs = "cs"), na.rm = TRUE) +
  scale_color_brewer(palette="Set1") + 
...
grid.arrange(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, ncol = 2)
```
