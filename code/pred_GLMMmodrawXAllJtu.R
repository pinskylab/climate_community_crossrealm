...
if(predmod == 'modrawsdTRealmtsignAllJtu'){
    mod <- readRDS(here('temp', 'modrawsdTRealmtsignAllJtu.rds'))
    out_preds <- 'preds_modrawsdTRealmtsignAllJtu.rds'
    out_slopes <- 'slopes_modrawsdTRealmtsignAllJtu.rds'
} 
